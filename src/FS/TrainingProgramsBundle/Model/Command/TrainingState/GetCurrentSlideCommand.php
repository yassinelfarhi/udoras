...
class GetCurrentSlideCommand implements CommandInterface
{
    /** @var EntityManager  */
    ...
    public function execute()
    {
        ...
        if($this->trainingState->getCurrentSlide() === 0){
        ...
        if($slideId === -1){
            ...
            $slides = $this->trainingState->getTraining()->getSlides()->count();
            $slide->setRealNum($slides + 1);
            return $slide;
        }
